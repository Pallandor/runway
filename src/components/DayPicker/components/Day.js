...
class Day extends Component {
  ...
  render() {
    const { day, modifiers, startLabel, endLabel, Icon } = this.props;
    ...
    return (
      ...
      >
        ...
        {(modifiers.start || modifiers.end) && (
          <SelectionLabel
            isStartDate={!!modifiers.start}
            label={modifiers.start ? startLabel : endLabel}
            Icon={Icon}
          />
        )}
        {/* <span
